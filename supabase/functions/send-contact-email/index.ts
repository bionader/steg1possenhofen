...
// Server-zu-Server-Requests (ohne Origin-Header) werden auf den ersten Eintrag gemappt
// — schadet nicht, da CORS nur für Browser-Sandbox-Schutz greift.
...
serve(async (req) => {
  ...
  const guestHtml = `
    <div style="font-family:'DM Sans',Arial,sans-serif;max-width:520px;margin:0 auto;background:#FDFAF4;border-radius:16px;overflow:hidden">
      ...
      <!-- Foto -->
      <img src="https://raw.githubusercontent.com/bionader/steg1possenhofen/main/images/mail-hero.jpg" alt="Steg 1 Possenhofen am Starnberger See" style="width:100%;display:block;max-height:260px;object-fit:cover;object-position:center" />
